...
export async function getCycleInsights(userId: string): Promise<any> {
  try {
    ...
    return {
      ...
      predictedNextPeriod: prediction.nextPeriodDates,
      predictedNextOvulation: prediction.ovulationWindows,
      predictedSymptoms: prediction.predictedSymptoms,
      fertileWindow: prediction.fertileWindows,
      cycleDuration: prediction.cycleDurations,
      cycleMetrics: {
